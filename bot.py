...
async def moosecite(ctx):
    try:
        citations = [
            ...
            "I once tried to vibe with a traffic light — Moosehead's urban exploration log",
            "I once tried to teach a calculator to lie — Moosehead's math rebellion",
            "I once tried to vibe-check a goose — Moosehead's avian feud",
            ...
            "I once tried to vibe with a potato that podcasts — Moosehead's media empire",
            ...
            "I once tried to vibe with a pigeon that passed the bar — Moosehead's legal team",
            ...
            "I once tried to vibe with a cursed spreadsheet cell named A666 — Moosehead's Excel exorcism",
            "I once tried to vibe with the ghost of my unread emails — Moosehead's inbox trauma",
            ...
            "I once tried to vibe with a TikTok chef who cooks with glitter — Moosehead's dinner party",
            "I once tried to vibe with a boy band member from 2003 — Moosehead's musical regret"
        ]
