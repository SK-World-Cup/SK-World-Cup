...
async def moosecite(ctx):
    citations = [
        ...
        '"I once got kicked out of a museum for arguing with a statue" — Moosehead\'s art critique journal',
        '"I\'m the reason your shampoo bottle screams" — Moosehead\'s bathroom science experiment',
        '"I once tried to copyright the word \'vibe\'" — Moosehead\'s legal battle with the dictionary',
        '"I\'m the inventor of emotional turbulence" — Moosehead\'s airline complaint letter',
        ...
        '"I\'m the inventor of the phrase \'chaotic neutral but make it fashion\'" — Moosehead\'s runway debut',
        '"I once got banned from a spelling bee for spelling \'Moosehead\' with 3 Zs" — Moosehead\'s academic downfall',
        '"I\'m the reason your horoscope cried" — Moosehead\'s astrology blog',
        '"I once tried to start a cult based on snack foods" — Moosehead\'s spiritual misfire',
        '"I\'m the emotional support gremlin" — Moosehead\'s therapy certification (revoked)',
        '"I once got kicked out of a karaoke bar for singing in Morse code" — Moosehead\'s musical memoir'
]
